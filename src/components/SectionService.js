...
const SectionService = () => {
    return (
        <div className="py-[40px]">
            <div className="container rounded-[20px] py-[40px] px-[30px]" style={{ backgroundImage: 'linear-gradient(190deg, #FFFFFF -278.56%, #6D6D6D -78.47%, #11101D 91.61%)', boxShadow: '0px 20px 100px -10px rgba(66, 71, 91, 0.1)' }}>
